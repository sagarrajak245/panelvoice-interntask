...
const TextToSpeechTab = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-1 md:p-2 border border-gray-200 w-full max-w-4xl mx-auto relative overflow-hidden">
      <div className="p-4 md:p-6">
        <textarea
          className="w-full h-48 p-4 border border-gray-200 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-pink-400 text-gray-700"
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button className="text-xs bg-gray-100 text-gray-700 px-3 py-1 rounded-full hover:bg-gray-200">Samara</button>
          <button className="text-xs bg-gray-100 text-gray-700 px-3 py-1 rounded-full hover:bg-gray-200">Spuds</button>
          <button className="text-xs bg-gray-100 text-gray-700 px-3 py-1 rounded-full hover:bg-gray-200">Jessica</button>
        </div>
        <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
          <div className="relative">
            <select
              ...
              className="appearance-none bg-gray-100 border border-gray-300 rounded-md py-2 pl-4 pr-10 text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 cursor-pointer"
            >
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="text-gray-400 hover:text-gray-700 p-2 rounded-full hover:bg-gray-100">
              <DownloadIcon />
            </button>
          </div>
        </div>
      ...
      <div className="px-6 py-3 bg-white flex justify-center items-center border-t border-gray-200">
        <p className="text-xs text-gray-500">Powered by Eleven v3 (alpha)</p>
      </div>
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      <header className="py-6 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto flex justify-between items-center">
          <div className="text-2xl font-bold tracking-tighter">IIElevenLabs</div>
          ...
          <div className="flex items-center space-x-2">
            <button className="px-4 py-2 text-sm font-semibold rounded-lg hover:bg-gray-100">Log In</button>
      ...
      <main className="container mx-auto px-4 pt-12 pb-24 text-center">
        ...
        <div className="flex justify-center space-x-4 mb-16">
          ...
          <button className="bg-white text-black font-semibold py-3 px-6 rounded-lg border border-gray-300 hover:bg-gray-100">CONTACT SALES</button>
        </div>
